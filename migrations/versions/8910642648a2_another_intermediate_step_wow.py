"""Another intermediate step wow

Revision ID: 8910642648a2
Revises: c8e1f94ee797
Create Date: 2020-03-29 20:22:04.184563
...
revision = '8910642648a2'
down_revision = 'c8e1f94ee797'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('pet_type', postgresql.ENUM('Dog', 'Cat', 'Rodent', 'Fish', 'Bird', 'Reptile', 'Amphibian', 'Other', name='pet_type'), autoincrement=False, nullable=False),
