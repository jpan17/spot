...
Revision ID: 144b579987a9
Revises: 9936747d3b3f
Create Date: 2020-03-24 20:34:54.296423
...
revision = '144b579987a9'
down_revision = '9936747d3b3f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('pet_type', sa.Enum('Dog', 'Cat', 'Rodent', 'Fish', 'Bird', 'Reptile', 'Other', name='pet_type'), nullable=False),
    ...
    sa.Column('activities', sa.ARRAY(sa.Enum('Feeding', 'Walking', 'Playing', 'Grooming', 'Bathing', 'Other', name='activities'), dimensions=1), nullable=False),
